"""
Refactored version of markov using classes
...
class Markov:
    """Markov analysis of a text
    suffix_map = dict linking prefixes to a list of possible next words
    prefix = a tuple of current prefixes
    """
